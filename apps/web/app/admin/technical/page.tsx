...
export default function TechnicalAnalyticsDashboard() {
  ...
  return (
    <div className="container mx-auto p-4 sm:p-6 space-y-4 sm:space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Technical Analytics</h1>
          <p className="text-sm sm:text-base text-gray-600 mt-1">
            Real-time system monitoring, risk analysis, and technical dashboard components
          </p>
        </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="text-sm font-medium text-blue-900">
                Sacred Architecture Technical Dashboard
              </h3>
              <p className="text-sm text-blue-800 mt-1">
                This dashboard showcases the new technical frontend components for event timeline visualization,
