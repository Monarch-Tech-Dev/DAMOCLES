...
export default function CreditorRankingsPage() {
  ...
  // Sort creditors by violation score (descending) for compliance transparency
  const sortedCreditors = [...creditors].sort((a, b) =>
    b.violationScore - a.violationScore
  );

  const lowestCompliance = sortedCreditors.slice(0, 5);
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Lowest Compliance Scores - Transparency Board */}
        <Card className="mb-8 border-red-200 bg-red-50">
          ...
          <CardContent>
            <div className="space-y-4">
              {lowestCompliance.map((creditor, index) => {
